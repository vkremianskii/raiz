...
import net.kremianskii.roots.jooq.JooqAggregateRepository;
...
import static net.kremianskii.roots.exampleservice.DatabaseSchema.ACCOUNT;
import static net.kremianskii.roots.exampleservice.DatabaseSchema.ACCOUNT_BALANCE;
import static net.kremianskii.roots.exampleservice.DatabaseSchema.ACCOUNT_ID;
import static net.kremianskii.roots.exampleservice.DatabaseSchema.ACCOUNT_VERSION;
